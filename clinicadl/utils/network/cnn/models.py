...
from clinicadl.utils.network.sub_network import CNN, CNN_FS, CNN_SSDA, CNN_SSDA_INIT, CNN_SSDA_INIT_MC, CNN_SSDA_FS,CNN_SSDA_FS_DEBUG
...
class Conv5_FC3_SSDA_DEBUG(CNN_SSDA_FS_DEBUG):
    """
    Reduce the 2D or 3D input image to an array of size output_size.
    """
...
class Conv5_FC3_SSDA_FS(CNN_SSDA_FS):
    """
    Reduce the 2D or 3D input image to an array of size output_size.
    """

...
class AttentionDesigner3D(nn.Module):
    """Residual Attention Network
    Args:
        block_num: attention module number for each stage
    """

    def __init__(self, block_num=[1, 1, 1], num_classes=2,pretrained=None, dropout=0):
        super(AttentionDesigner3D, self).__init__()
        ...
        self.stage1 = self._make_stage(8, 16, block_num[0], AttentionModule1)
        self.stage2 = self._make_stage(16, 32, block_num[1], AttentionModule2)
        self.stage3 = self._make_stage(32, 64, block_num[2], AttentionModule3)

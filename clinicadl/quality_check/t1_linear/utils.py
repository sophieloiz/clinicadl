...
class QCDataset(Dataset):
    ...
    def __init__(
        ...
        self.preprocessing_dict = {
            "preprocessing": "flair-linear",
            "mode": "image",
            "use_uncropped_image": False,
            "file_type":   "*space-MNI152NLin2009cSym_desc-Crop_res-1x1x1_flair.nii.gz",
           # "pattern":
    ...
    def __getitem__(self, idx):
        ...
        sample = {"image": image, "participant_id": subject, "session_id": session, "label": label}
        print(sample["label"])
